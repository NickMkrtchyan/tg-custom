                    ...
                    <form method="post" action="options.php">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_msg_menu_header" 
                                        value="<?php echo esc_attr(get_option('tgcb_msg_menu_header', '👇 <b>Главное меню</b>')); ?>" class="large-text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_btn_all_courses" 
                                        value="<?php echo esc_attr(get_option('tgcb_btn_all_courses', '📚 Все курсы')); ?>" class="regular-text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_btn_my_courses" 
                                        value="<?php echo esc_attr(get_option('tgcb_btn_my_courses', '👤 Мои курсы')); ?>" class="regular-text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_btn_support" 
                                        value="<?php echo esc_attr(get_option('tgcb_btn_support', '👨‍💻 Поддержка')); ?>" class="regular-text">
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <textarea name="tgcb_msg_welcome" rows="3" class="large-text"><?php echo esc_textarea(get_option('tgcb_msg_welcome', "👋 Добро пожаловать, {name}!\n\nПожалуйста, выберите курс из списка:\n\nПосле выбора отправьте скриншот чека об оплате.")); ?></textarea>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_msg_no_courses" 
                                        value="<?php echo esc_attr(get_option('tgcb_msg_no_courses', 'На данный момент курсы недоступны.')); ?>" class="large-text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_msg_banned" 
                                        value="<?php echo esc_attr(get_option('tgcb_msg_banned', '❌ Вы забанены в этом боте.')); ?>" class="large-text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_msg_select_first" 
                                        value="<?php echo esc_attr(get_option('tgcb_msg_select_first', '❌ Пожалуйста, сначала выберите курс через /start')); ?>" class="large-text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgcb_msg_already_joined" 
                                        value="<?php echo esc_attr(get_option('tgcb_msg_already_joined', '✅ У вас уже есть доступ к этому курсу!')); ?>" class="large-text">
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="tgcb_msg_rejected" rows="3" class="large-text"><?php echo esc_textarea(get_option('tgcb_msg_rejected', "❌ <b>Оплата отклонена</b>\n\nК сожалению, ваш платеж не подтвержден.\nПожалуйста, свяжитесь с поддержкой.")); ?></textarea>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <textarea name="tgcb_msg_my_courses_header" rows="2" class="large-text"><?php echo esc_textarea(get_option('tgcb_msg_my_courses_header', "👤 <b>Мои курсы</b>\n\nУ вас есть доступ к следующим курсам:\n\n")); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label><?php _e('My Courses (Empty)', 'tg-course-bot-pro'); ?></label></th>
                                <td>
                                    <textarea name="tgcb_msg_my_courses_empty" rows="2" class="large-text"><?php echo esc_textarea(get_option('tgcb_msg_my_courses_empty', "👤 <b>Мои курсы</b>\n\nВы еще не записались ни на один курс.\nВыберите '📚 Все курсы', чтобы начать!")); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label><?php _e('Help Message', 'tg-course-bot-pro'); ?></label></th>
                                <td>
                                    <textarea name="tgcb_msg_help" rows="6" class="large-text"><?php echo esc_textarea(get_option('tgcb_msg_help', "❓ <b>Как использовать бота:</b>\n\n1️⃣ Нажмите <b>📚 Все курсы</b>\n2️⃣ Выберите курс\n3️⃣ Отправьте скриншот оплаты\n4️⃣ Ждите подтверждения\n5️⃣ Получите ссылку!\n\nНажмите <b>👤 Мои курсы</b> для просмотра подписок.")); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label><?php _e('Support Message', 'tg-course-bot-pro'); ?></label></th>
                                <td>
                                    <textarea name="tgcb_msg_support" rows="2" class="large-text"><?php echo esc_textarea(get_option('tgcb_msg_support', "👨‍💻 <b>Поддержка</b>\n\nЕсли у вас есть вопросы, напишите администратору.")); ?></textarea>
                                </td>
                            </tr>
                        </table>
